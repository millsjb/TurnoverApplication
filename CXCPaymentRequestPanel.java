...
import forms.PaymentRequestForm;

public class CXCPaymentRequestPanel extends JPanel implements ActionListener{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8254652113095045511L;

	public CXCPaymentRequestPanel()
	{
		...
		drawScreen();
		JScrollPane scrollPane = new JScrollPane(paymentRequestForm);
	...
	public static PaymentRequestForm getForm()
	{
